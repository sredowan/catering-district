            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex flex-col justify-end sm:items-center sm:justify-center px-0 sm:px-6">
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        onClick={onClose}
                        className="absolute inset-0 bg-[#19355e]/60 backdrop-blur-sm"
                    ></motion.div>
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-2xl bg-[#ffffff] rounded-t-3xl sm:rounded-3xl shadow-2xl max-h-[90vh] overflow-hidden flex flex-col"
                    >
                        {/* Header */}
                        <div className="flex items-center justify-between px-6 py-5 border-b border-[#19355e]/10 shrink-0 bg-[#ffffff] z-10 sticky top-0">
                            <h2 className="text-2xl font-serif text-[#19355e]">Make a <span className="italic">Reservation</span></h2>
                            <button onClick={onClose} className="p-2 rounded-full hover:bg-[#19355e]/5 transition-colors text-[#19355e]/60 hover:text-[#19355e]">
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                                ...
                                <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                            ...
                                            <div className="relative">
                                                <Mail className="absolute left-4 top-3.5 w-4 h-4 text-[#19355e]/40" />
                                                <input 
                                            ...
                                            <div className="relative sm:col-span-2">
                                                <Phone className="absolute left-4 top-3.5 w-4 h-4 text-[#19355e]/40" />
                                                <input 
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                            ...
                                            <div className="relative flex">
                                                <div className="relative w-1/2 pr-2">
                                                    <Users className="absolute left-4 top-3.5 w-4 h-4 text-[#19355e]/40" />
                                                    <input 
                                                ...
                                                <div className="relative w-1/2 pl-2">
                                                    ...
                                                    <label className="absolute -top-2 left-4 px-1 text-[10px] uppercase font-bold text-[#19355e]/40 bg-white">Meal</label>
                                                </div>
                                            </div>
                                            <div className="relative sm:col-span-2">
                                                <Clock className="absolute left-4 top-3.5 w-4 h-4 text-[#19355e]/40" />
                                                <input 
                                                    type="time" required
                        ...
                        <AnimatePresence>
                            {showTerms && (
                                ...
                                >
                                    <div className="flex items-center justify-between px-6 py-5 border-b border-[#19355e]/10 shrink-0 bg-[#ffffff]">
                                        <h3 className="text-xl font-serif text-[#19355e]">Terms & Conditions</h3>
                                        <button onClick={() => setShowTerms(false)} className="px-4 py-2 bg-[#19355e]/5 hover:bg-[#19355e]/10 rounded-full text-xs uppercase tracking-widest font-medium transition-colors">
                                            Close
                                        </button>
                                    </div>
                                    <div className="overflow-y-auto p-6 sm:p-10 text-sm font-light leading-relaxed text-[#19355e]/80 space-y-6">
                                        ...
                                        <h4 className="font-medium text-[#19355e] uppercase text-xs tracking-widest mt-8 mb-4">Data Protection & Privacy (GDPR)</h4>
